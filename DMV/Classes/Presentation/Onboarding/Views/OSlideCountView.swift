...
private extension OSlideCountView {
    ...
    func makeChoiseContainer() -> UIView {
        let view = UIView()
        view.backgroundColor = UIColor(integralRed: 241, green: 246, blue: 254)
    ...
    func makeLargeCirleView() -> CountCircleView {
        ...
        view.value = 1
        view.pieBackgroundColor = UIColor(integralRed: 241, green: 246, blue: 254)
        view.pieFilledColor = UIColor(integralRed: 255, green: 252, blue: 226)
    ...
    func makeSmallCirleView() -> CountCircleView {
        let view = CountCircleView()
        view.value = 1
        view.pieBackgroundColor = UIColor(integralRed: 91, green: 144, blue: 242)
        view.pieFilledColor = UIColor(integralRed: 254, green: 241, blue: 129)
        view.backgroundColor = UIColor.clear
        view.translatesAutoresizingMaskIntoConstraints = false
        addSubview(view)
        return view
