...
private extension OSlidePreloaderView {
    func initialize() {
        backgroundColor = UIColor(integralRed: 73, green: 132, blue: 241)
    }
...
private extension OSlidePreloaderView {
    func makeConstraints() {
        NSLayoutConstraint.activate([
            ...
            imageView.heightAnchor.constraint(equalToConstant: 280.scale),
            imageView.bottomAnchor.constraint(equalTo: titleLabel.topAnchor, constant: -40.scale)
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            titleLabel.bottomAnchor.constraint(equalTo: progressView.topAnchor, constant: -48.scale)
        ])
...
private extension OSlidePreloaderView {
    ...
    func makeProgressView() -> UIProgressView {
        ...
        view.layer.cornerRadius = 29.5.scale
        view.layer.masksToBounds = true
        view.trackTintColor = UIColor(integralRed: 61, green: 115, blue: 214)
        view.progressTintColor = UIColor(integralRed: 254, green: 241, blue: 129)
        view.translatesAutoresizingMaskIntoConstraints = false
        addSubview(view)
        return view
    }
