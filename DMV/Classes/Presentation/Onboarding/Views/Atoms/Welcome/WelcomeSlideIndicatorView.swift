...
private extension WelcomeSlideIndicatorView {
    ...
    func update() {
        indicator1View.backgroundColor = UIColor(integralRed: 73, green: 132, blue: 241, alpha: index == 1 ? 1 : 0.2)
        indicator2View.backgroundColor = UIColor(integralRed: 73, green: 132, blue: 241, alpha: index == 2 ? 1 : 0.2)
        indicator3View.backgroundColor = UIColor(integralRed: 73, green: 132, blue: 241, alpha: index == 3 ? 1 : 0.2)
