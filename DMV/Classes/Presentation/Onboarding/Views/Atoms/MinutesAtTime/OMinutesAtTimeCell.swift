...
final class OMinutesAtTimeCell: UIView {
    var isSelected: Bool = false {
        didSet {
            ...
            layer.borderColor = isSelected ? UIColor(integralRed: 73, green: 132, blue: 241).cgColor : UIColor.clear.cgColor
            backgroundColor = isSelected ? UIColor(integralRed: 73, green: 132, blue: 241, alpha: 0.2) : UIColor(integralRed: 241, green: 246, blue: 254)
        }
    }
