...
final class OnboardingView: UIView {
    enum Step: Int {
        case welcome, locale, experience, goals, mode, whenTaking, minutesAtTime, count, whenStudy, push, preloader, plan
    }
...
private extension OnboardingView {
    ...
    func headerUpdate() {
        ...
        let progressCases: [Step] = [
            .experience, .goals, .mode, .whenTaking, .minutesAtTime, .count, .whenStudy
        ]
