...
extension PaygateIndicatorView {
    func select(isFirst: Bool) {
        view1.backgroundColor = UIColor(integralRed: 73, green: 132, blue: 241).withAlphaComponent(isFirst ? 0.2 : 1)
        view2.backgroundColor = UIColor(integralRed: 73, green: 132, blue: 241).withAlphaComponent(isFirst ? 1 : 0.2)
    }
}
